...
<div class="about-us-area section-padding">
			  ...
			  <?php
			   $con=mysql_query("select * from delivery")or die(mysql_error());
			   ...
			   <td>$date</td>
			   <td>$loc</td>
			   <td><a href='viewdelivery.php?did=$did' class='button extra-small mb-20'><span>Delete</span></a></td></tr>";
			   }
			   ?>
			  </table>
...
{
$did=$_GET['did'];
mysql_query("delete from delivery where did='$did'");
